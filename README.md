...
* 3-Numerical_Regression.ipynb loads the Boston dataset, trains two numerical regressopn models (linear and KNN), evaluates their performances and visualizes the models. 
